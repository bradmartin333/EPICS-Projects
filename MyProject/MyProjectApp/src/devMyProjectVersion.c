...
#include "MyProjectVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = MyProjectVERSION;
...
static lsidset devMyProjectVersion = {
	{5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devMyProjectVersion);
